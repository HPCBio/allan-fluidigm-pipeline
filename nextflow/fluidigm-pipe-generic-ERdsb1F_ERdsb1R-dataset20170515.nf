...
/*
* USAGE: nextflow run fluidigm-pipe-generic-ERdsb1F_ERdsb1R-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "ERdsb1F_ERdsb1R"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/ERdsb1F_ERdsb1R"
...
params.R1adaptorLen  = '23'                        // required. length of adaptor for R1. This value comes from the sequencing report
params.R1maxlen      = '227'                       // required. maximum sequence length of R1 after qctrim (deafult value= readlen -adaptorlen)   
...
params.maxSeqLen     = '449'                       // maximum sequence length of STITCHED read
...
params.minoverlap    = '8'                        // default=20
...
====================================
 B_Allan FLUIDIGM-ERdsb1F_ERdsb1R : Fluidigm qctrim and vsearch clustering for ERdsb1F_ERdsb1R dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-ERdsb1F_ERdsb1R : Fluidigm qctrim and vsearch clustering for ERdsb1F_ERdsb1R dataset-20170515"
