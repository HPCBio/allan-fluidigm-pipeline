...
/*
* USAGE: nextflow run fluidigm-pipe-generic-RconOB2F_RconOB2R-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "RconOB2F_RconOB2R"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/RconOB2F_RconOB2R"
...
params.maxSeqLen     = '399'                       // maximum sequence length of STITCHED read
...
params.minoverlap    = '60'                        // default=20
...
====================================
 B_Allan FLUIDIGM-RconOB2F_RconOB2R : Fluidigm qctrim and vsearch clustering for RconOB2F_RconOB2R dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-RconOB2F_RconOB2R : Fluidigm qctrim and vsearch clustering for RconOB2F_RconOB2R dataset-20170515"
