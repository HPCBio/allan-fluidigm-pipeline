...
/*
* USAGE: nextflow run fluidigm-pipe-generic-16S8FE3_B_GA1B2-dataset20170515.nf -qs 6
...
/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/16S8FE3_B_GA1B2"
...
====================================
 B_Allan FLUIDIGM-16S8FE3_B_GA1B2 : Fluidigm qctrim and vsearch clustering for 16S8FE3_B_GA1B2 dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-16S8FE3_B_GA1B2 : Fluidigm qctrim and vsearch clustering for 16S8FE3_B_GA1B2 dataset-20170515"
