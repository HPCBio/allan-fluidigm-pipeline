...
/*
* USAGE: nextflow run fluidigm-pipe-generic-F566Euk_R1200Euk-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "F566Euk_R1200Euk"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/F566Euk_R1200Euk"
...
params.R2maxlen      = '228'                       // maximum sequence length of R2 after qctrim (deafult value= readlen -adaptorlen)   
params.R2adaptorLen  = '22'                        // length of adaptor for R2. This value comes from the sequencing report
...
====================================
 B_Allan FLUIDIGM-F566Euk_R1200Euk : Fluidigm qctrim and vsearch clustering for F566Euk_R1200Euk dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-F566Euk_R1200Euk : Fluidigm qctrim and vsearch clustering for F566Euk_R1200Euk dataset-20170515"
