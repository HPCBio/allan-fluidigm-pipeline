...
/*
* USAGE: nextflow run fluidigm-pipe-generic-V4_515F_New_V4_806R_New-dataset20170515.nf -qs 6
...
/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/V4_515F_New_V4_806R_New"
...
params.skipStitch    = 'NO'                        // required. possible values YES NO
params.readLen       = '250'                       // required. read length
params.R1minlen      = '170'                       // required. minimum sequence length after qctrim of R1
params.R1maxlen      = '231'                       // required. maximum sequence length of R1 after qctrim (deafult value= readlen -adaptorlen)
params.R1adaptorLen  = '19'                        // required. length of adaptor for R1. This value comes from the sequencing report
params.R2minlen      = '170'                       // needed for stitching case. minimum sequence length of R2 after qctrim 
params.R2maxlen      = '230'                       // needed for stitching case. maximum sequence length of R2 after qctrim (deafult value= readlen -adaptorlen)   
params.R2adaptorLen  = '20'                        // needed for stitching case. length of adaptor for R2. This value comes from the sequencing report
params.maxSeqLen     = '292'                       // needed for stitching case. maximum sequence length of STITCHED read
params.minSeqLen     = '170'                       // needed for stitching case. minimum sequence length of STITCHED read
params.minqual       = '30'                        // required. minimum base quality. The range goes from 0-40                        
params.minoverlap    = '150'                       // default=20
...
====================================
 B_Allan FLUIDIGM-V4_515F_New_V4_806R_New : Fluidigm qctrim and vsearch clustering for V4_515F_New_V4_806R_New dataset-20170515 
====================================
...
/*
* Step 1. Trimmomatic, PEAR, concat, convert2fasta
*/
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-V4_515F_New_V4_806R_New : Fluidigm qctrim and vsearch clustering for V4_515F_New_V4_806R_New dataset-20170515"
