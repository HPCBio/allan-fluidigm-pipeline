...
/*
* USAGE: nextflow run fluidigm-pipe-generic-RaesOB2F_RmonOB2R-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "RaesOB2F_RmonOB2R"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/RaesOB2F_RmonOB2R"
...
params.maxSeqLen     = '410'                       // maximum sequence length of STITCHED read
...
====================================
 B_Allan FLUIDIGM-RaesOB2F_RmonOB2R : Fluidigm qctrim and vsearch clustering for RaesOB2F_RmonOB2R dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-RaesOB2F_RmonOB2R : Fluidigm qctrim and vsearch clustering for RaesOB2F_RmonOB2R dataset-20170515"
