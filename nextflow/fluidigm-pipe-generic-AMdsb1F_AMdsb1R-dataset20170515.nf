...
/*
* USAGE: nextflow run fluidigm-pipe-generic-AMdsb1F_AMdsb1R-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "AMdsb1F_AMdsb1R"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/AMdsb1F_AMdsb1R"
...
params.R1adaptorLen  = '20'                        // required. length of adaptor for R1. This value comes from the sequencing report
params.R1maxlen      = '230'                       // required. maximum sequence length of R1 after qctrim (deafult value= readlen -adaptorlen)   
...
params.maxSeqLen     = '431'                       // maximum sequence length of STITCHED read
...
====================================
 B_Allan FLUIDIGM-AMdsb1F_AMdsb1R : Fluidigm qctrim and vsearch clustering for AMdsb1F_AMdsb1R dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-AMdsb1F_AMdsb1R : Fluidigm qctrim and vsearch clustering for AMdsb1F_AMdsb1R dataset-20170515"
