...
/*
* USAGE: nextflow run fluidigm-pipe-generic-RmasOB1F_RafrOB1R-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "RmasOB1F_RafrOB1R"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/RmasOB1F_RafrOB1R"
...
params.maxSeqLen     = '425'                       // maximum sequence length of STITCHED read
...
params.minoverlap    = '35'                        // default=20
...
====================================
 B_Allan FLUIDIGM-RmasOB1F_RafrOB1R : Fluidigm qctrim and vsearch clustering for RmasOB1F_RafrOB1R dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-RmasOB1F_RafrOB1R : Fluidigm qctrim and vsearch clustering for RmasOB1F_RafrOB1R dataset-20170515"
