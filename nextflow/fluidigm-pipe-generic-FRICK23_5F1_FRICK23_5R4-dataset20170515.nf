...
/*
* USAGE: nextflow run fluidigm-pipe-generic-FRICK23_5F1_FRICK23_5R4-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "FRICK23_5F1_FRICK23_5R4"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/FRICK23_5F1_FRICK23_5R4"
...
params.R1minlen      = '170'                       // required. minimum sequence length after qctrim
...
params.R2maxlen      = '229'                       // maximum sequence length of R2 after qctrim (deafult value= readlen -adaptorlen)   
params.R2adaptorLen  = '21'                        // length of adaptor for R2. This value comes from the sequencing report
params.maxSeqLen     = '231'                       // maximum sequence length of STITCHED read
...
====================================
 B_Allan FLUIDIGM-FRICK23_5F1_FRICK23_5R4 : Fluidigm qctrim and vsearch clustering for FRICK23_5F1_FRICK23_5R4 dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-FRICK23_5F1_FRICK23_5R4 : Fluidigm qctrim and vsearch clustering for FRICK23_5F1_FRICK23_5R4 dataset-20170515"
