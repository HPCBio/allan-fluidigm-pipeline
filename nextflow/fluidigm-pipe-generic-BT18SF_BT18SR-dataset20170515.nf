...
/*
* USAGE: nextflow run fluidigm-pipe-generic-BT18SF_BT18SR-dataset20170515.nf -qs 6
...
/*Name of inputs*/
params.Amplicon      = "BT18SF_BT18SR"         // The name of the Amplicon as it appears in the sequencing report and in the filenames of the reads
params.SeqLot        = "20170515"                        // This string that indicate the provenance of the Amplicon. Default: the date of the sequencing run


/*input channels */
rawDataPath = "$projectPath/newdata/rawReads/20170515_rawReads/BT18SF_BT18SR"
...
params.R1adaptorLen  = '22'                        // required. length of adaptor for R1. This value comes from the sequencing report
params.R1maxlen      = '228'                       // required. maximum sequence length of R1 after qctrim (deafult value= readlen -adaptorlen)   
params.R2minlen      = '170'                       // minimum sequence length of R2 after qctrim 
params.R2maxlen      = '227'                       // maximum sequence length of R2 after qctrim (deafult value= readlen -adaptorlen)   
params.R2adaptorLen  = '23'                        // length of adaptor for R2. This value comes from the sequencing report
params.maxSeqLen     = '228'                       // maximum sequence length of STITCHED read
...
====================================
 B_Allan FLUIDIGM-BT18SF_BT18SR : Fluidigm qctrim and vsearch clustering for BT18SF_BT18SR dataset-20170515 
====================================
...
workflow.onComplete {
    def subject = "[Task #${params.ticket}]  B_Allan FLUIDIGM-BT18SF_BT18SR : Fluidigm qctrim and vsearch clustering for BT18SF_BT18SR dataset-20170515"
